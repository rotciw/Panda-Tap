$(document).ready(function () {
  $("#boss").hide();
  var coinLogo = " <img src='images/coins.svg' class='themeicon'> ";
  var amountLogo = "<img src='images/stacked.svg' class='themeicon'> ";
  var bossKilledLogo = "<img src='images/skull.svg' class='themeicon'> ";
  var bossDMGLogo = "<img src='images/sword.svg' class='themeicon'> ";
  var bossSpeedLogo = "<img src='images/speed.svg' class='themeicon'> ";
  var clickMoneyLogo = "<img src='images/pointer.svg' class='themeicon'> ";
  var dragonLogo = "<img src='images/dragon.svg' class='themeicon'> ";
  ...
  function millionize(input) {
    ...
    //Thousands
      ...
      return (
        ((input * Math.pow(10, 3)) / Math.pow(10, 6)).toFixed(2) + " thousand"
      );
    }
    //Million
    else if (input >= Math.pow(10, 6) && input < Math.pow(10, 9)) {
      return (
        ((input * Math.pow(10, 6)) / Math.pow(10, 12)).toFixed(2) + " million"
      );
    }
    //Billion
    else if (input >= Math.pow(10, 9) && input < Math.pow(10, 12)) {
      return (
        ((input * Math.pow(10, 9)) / Math.pow(10, 18)).toFixed(2) + " billion"
      );
    }
    //Trillion
    else if (input >= Math.pow(10, 12) && input < Math.pow(10, 15)) {
      return (
        ((input * Math.pow(10, 12)) / Math.pow(10, 24)).toFixed(2) + " trillion"
      );
    }
    //Quadrillion
    else if (input >= Math.pow(10, 15) && input < Math.pow(10, 18)) {
      return (
        ((input * Math.pow(10, 15)) / Math.pow(10, 30)).toFixed(2) +
        " quadrillion"
      );
    }
    //Quintillion
      ...
      return (
        ((input * Math.pow(10, 18)) / Math.pow(10, 36)).toFixed(2) +
        " quintillion"
      );
    }
    //Sextillion
      ...
      return (
        ((input * Math.pow(10, 21)) / Math.pow(10, 42)).toFixed(2) +
        " sextillion"
      );
    }
  }
  ...
  if (Modernizr.localstorage) {
    ...
    $("#heroUpgrade1").click(function () {
      if (player.money >= sword.hcost) {
        ...
        player.dmg++;
        sword.timesUp++;
        sword.hcost = 100 * Math.pow(1.2, sword.timesUp);
        if (sword.timesUp > 0) {
    ...
    $("#gloryRoad").click(function () {
      if (player.money >= gloryRoad.hcost) {
        ...
        gloryRoad.timesUp++;
        gloryRoad.hcost = 30000 * Math.pow(1.2, gloryRoad.timesUp);
      } else {
        Command: toastr["warning"]("You don't have enough.");
      }
    });
    ...
    $("#heroUpgrade4").click(function () {
      if (player.money >= clickbetter.hcost) {
        ...
        clickbetter.hcost = 50 * Math.pow(1.1, clickbetter.timesUp);
    ...
    setInterval(function () {
      player.moneyPerClick =
        1 + clickbetter.timesUp + player.moneyPerSec * 0.01 * clickperc.timesUp;

      clickperc.hcost = 100000 * Math.pow(1.15, clickperc.timesUp);

      document.getElementById("priceSword").innerHTML =
        coinLogo + millionizeUpgrades(sword.hcost.toFixed(0));
      document.getElementById("heroUpgrade1Amount").innerHTML =
        amountLogo + sword.timesUp.toFixed(0);
      document.getElementById("priceGloryRoad").innerHTML =
        coinLogo + millionizeUpgrades(gloryRoad.hcost.toFixed(0));
      document.getElementById("gloryRoadAmount").innerHTML =
        amountLogo + gloryRoad.timesUp.toFixed(0);

      if (gf.timesUp >= 10) {
        document.getElementById("pricegf").innerHTML = "Maxed";
      } else {
        document.getElementById("pricegf").innerHTML =
          coinLogo + millionizeUpgrades(gf.hcost.toFixed(0));
      }
      document.getElementById("heroUpgrade2Amount").innerHTML =
        amountLogo + gf.timesUp.toFixed(0);

      if (sensei.timesUp >= 4) {
        document.getElementById("pricesensei").innerHTML = "Maxed";
      } else {
        document.getElementById("pricesensei").innerHTML =
          coinLogo + millionizeUpgrades(sensei.hcost.toFixed(0));
      }
      document.getElementById("heroUpgrade3Amount").innerHTML =
        amountLogo + sensei.timesUp.toFixed(0);

      document.getElementById("priceClick").innerHTML =
        coinLogo + millionizeUpgrades(clickbetter.hcost.toFixed(0));
      document.getElementById("heroUpgrade4Amount").innerHTML =
        amountLogo + clickbetter.timesUp.toFixed(0);
      document.getElementById("priceClickPerc").innerHTML =
        coinLogo + millionizeUpgrades(clickperc.hcost.toFixed(0));
      document.getElementById("heroUpgrade5Amount").innerHTML =
        amountLogo + clickperc.timesUp.toFixed(0);

      if (boss.kills >= 10 && boss.kills < 20) {
        $(".bossSprite").css("background", "url(images/dragon2.gif) no-repeat");
        $(".bossSprite").css("background-size", "12vw 22vh");
        boss.name = "Teovanth The Brave";
      } else if (boss.kills >= 20 && boss.kills < 30) {
        $(".bossSprite").css("background", "url(images/tiger.gif) no-repeat");
        $(".bossSprite").css("background-size", "12vw 22vh");
        boss.name = "Barroth The Fast One";
      } else if (boss.kills >= 30 && boss.kills < 40) {
        $(".bossSprite").css("background", "url(images/bear.png) no-repeat");
        $(".bossSprite").css("background-size", "12vw 22vh");
    ...
    var researchFacility = new Upgrade(
      "Reasearch Facility",
      0,
      14 * Math.pow(10, 12),
      0
    ...
    setInterval(function () {
      ...
      player.money =
        ...
        (lazyPanda.income +
          ...
          alchemyPanda.income +
          bambooForest.income +
          researchFacility.income +
          pandaSchool.income +
          ninjaPanda.income) *
          Math.pow(1.01, player.bonusMon);
      ...
      document.getElementById("incomePerSec").innerHTML =
        "Income: " + millionize(player.moneyPerSec.toFixed(2)) + coinLogo;
      document.getElementById("monDisp").innerHTML =
        millionize(player.money.toFixed(2)) + coinLogo;
    ...
    $(
      "#buyNinjaPanda, #buyPandaSchool, #buyResearchFacility, #buyBambooForest, #buyAlchemyPanda, #buyWizardPanda, #buyPandaTemple, #buyRiceBank"
    ).hide();
    $(
      ".statback2, .statback3, .statback4, .statback5, .statback6, .statback7, .statback8, .statback9"
    ).hide();
    ...
    setInterval(function () {
      ...
      document.getElementById("lazyPandaAmount").innerHTML =
        amountLogo + lazyPanda.timesUpg;
      document.getElementById("priceLazyPanda").innerHTML =
        coinLogo + millionizeUpgrades(lazyPanda.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("workingPandaAmount").innerHTML =
        amountLogo + workingPanda.timesUpg;
      document.getElementById("priceWorkingPanda").innerHTML =
        coinLogo + millionizeUpgrades(workingPanda.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("riceFarmAmount").innerHTML =
        amountLogo + riceFarm.timesUpg;
      document.getElementById("priceRiceFarm").innerHTML =
        coinLogo + millionizeUpgrades(riceFarm.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("riceLabAmount").innerHTML =
        amountLogo + riceLab.timesUpg;
      document.getElementById("priceRiceLab").innerHTML =
        coinLogo + millionizeUpgrades(riceLab.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("riceFactoryAmount").innerHTML =
        amountLogo + riceFactory.timesUpg;
      document.getElementById("priceRiceFactory").innerHTML =
        coinLogo + millionizeUpgrades(riceFactory.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("riceBankAmount").innerHTML =
        amountLogo + riceBank.timesUpg;
      document.getElementById("priceRiceBank").innerHTML =
        coinLogo + millionizeUpgrades(riceBank.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("pandaTempleAmount").innerHTML =
        amountLogo + pandaTemple.timesUpg;
      document.getElementById("pricePandaTemple").innerHTML =
        coinLogo + millionizeUpgrades(pandaTemple.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("wizardPandaAmount").innerHTML =
        amountLogo + wizardPanda.timesUpg;
      document.getElementById("priceWizardPanda").innerHTML =
        coinLogo + millionizeUpgrades(wizardPanda.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("alchemyPandaAmount").innerHTML =
        amountLogo + alchemyPanda.timesUpg;
      document.getElementById("priceAlchemyPanda").innerHTML =
        coinLogo + millionizeUpgrades(alchemyPanda.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("bambooForestAmount").innerHTML =
        amountLogo + bambooForest.timesUpg;
      document.getElementById("priceBambooForest").innerHTML =
        coinLogo + millionizeUpgrades(bambooForest.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("researchFacilityAmount").innerHTML =
        amountLogo + researchFacility.timesUpg;
      document.getElementById("priceResearchFacility").innerHTML =
        coinLogo + millionizeUpgrades(researchFacility.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      document.getElementById("pandaSchoolAmount").innerHTML =
        amountLogo + pandaSchool.timesUpg;
      document.getElementById("pricePandaSchool").innerHTML =
        coinLogo + millionizeUpgrades(pandaSchool.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      document.getElementById("ninjaPandaAmount").innerHTML =
        amountLogo + ninjaPanda.timesUpg;
      document.getElementById("priceNinjaPanda").innerHTML =
        coinLogo + millionizeUpgrades(ninjaPanda.cost.toFixed(0));
    }, 20);
    ...
    setInterval(function () {
      ...
      $("#HPNum").html(
        millionizeUpgrades(boss.hp.toFixed(0)) +
          "/" +
          millionizeUpgrades(boss.maxhp.toFixed(0))
      );
      ...
      .addListener(function (unit, amount, total) {
        if (total == 0) {
          Command: toastr["error"](
            "You failed to beat the boss in time.",
            "Failed"
          );
        }
      });
    ...
    setInterval(function () {
      // Boss info
      document.getElementById("bossKills").innerHTML =
        bossKilledLogo + boss.kills;
      document.getElementById("bossSpeed").innerHTML =
        bossSpeedLogo + boss.speed;
      document.getElementById("bossDMG").innerHTML =
        bossDMGLogo + millionizeUpgrades(player.dmg).toFixed(0);
      document.getElementById("clickMoney").innerHTML =
        clickMoneyLogo + millionizeUpgrades(player.moneyPerClick.toFixed(0));
      document.getElementById("bonusIncome").innerHTML =
        dragonLogo + millionizeUpgrades(player.bonusMon).toFixed(0) + "%";
    ...
    window.onload = function () {
      ...
      if (typeof savegame.monClick !== "undefined")
        player.moneyPerClick = savegame.monClick;
      //Income
      if (typeof savegame.moneyPerSec !== "undefined")
        player.moneyPerSec = savegame.moneyPerSec;
      //Lazy Panda
      if (typeof savegame.lazyIncome !== "undefined")
        lazyPanda.income = savegame.lazyIncome;
      if (typeof savegame.lazyCost !== "undefined")
        lazyPanda.cost = savegame.lazyCost;
      if (typeof savegame.lazyUpg !== "undefined")
        lazyPanda.timesUpg = savegame.lazyUpg;
      //Working Panda
      if (typeof savegame.workingIncome !== "undefined")
        workingPanda.income = savegame.workingIncome;
      if (typeof savegame.workingCost !== "undefined")
        workingPanda.cost = savegame.workingCost;
      if (typeof savegame.workingUpg !== "undefined")
        workingPanda.timesUpg = savegame.workingUpg;
      //Rice Farm
      if (typeof savegame.riceCost !== "undefined")
        riceFarm.cost = savegame.riceCost;
      if (typeof savegame.riceIncome !== "undefined")
        riceFarm.income = savegame.riceIncome;
      if (typeof savegame.riceUpg !== "undefined")
        riceFarm.timesUpg = savegame.riceUpg;
      // Rice Lab
      if (typeof savegame.riceLabCost !== "undefined")
        riceLab.cost = savegame.riceLabCost;
      if (typeof savegame.riceLabIncome !== "undefined")
        riceLab.income = savegame.riceLabIncome;
      if (typeof savegame.riceLabUpg !== "undefined")
        riceLab.timesUpg = savegame.riceLabUpg;
      // Rice Factory
      if (typeof savegame.riceFactoryCost !== "undefined")
        riceFactory.cost = savegame.riceFactoryCost;
      if (typeof savegame.riceFactoryIncome !== "undefined")
        riceFactory.income = savegame.riceFactoryIncome;
      if (typeof savegame.riceFactoryUpg !== "undefined")
        riceFactory.timesUpg = savegame.riceFactoryUpg;
      // Rice Bank
      if (typeof savegame.riceBankCost !== "undefined")
        riceBank.cost = savegame.riceBankCost;
      if (typeof savegame.riceBankIncome !== "undefined")
        riceBank.income = savegame.riceBankIncome;
      if (typeof savegame.riceBankUpg !== "undefined")
        riceBank.timesUpg = savegame.riceBankUpg;
      // Panda Temple
      if (typeof savegame.pandaTempleCost !== "undefined")
        pandaTemple.cost = savegame.pandaTempleCost;
      if (typeof savegame.pandaTempleIncome !== "undefined")
        pandaTemple.income = savegame.pandaTempleIncome;
      if (typeof savegame.pandaTempleUpg !== "undefined")
        pandaTemple.timesUpg = savegame.pandaTempleUpg;
      // Wizard Panda
      if (typeof savegame.wizardPandaCost !== "undefined")
        wizardPanda.cost = savegame.wizardPandaCost;
      if (typeof savegame.wizardPandaIncome !== "undefined")
        wizardPanda.income = savegame.wizardPandaIncome;
      if (typeof savegame.wizardPandaUpg !== "undefined")
        wizardPanda.timesUpg = savegame.wizardPandaUpg;
      // Alchemy Panda
      if (typeof savegame.alchemyPandaCost !== "undefined")
        alchemyPanda.cost = savegame.alchemyPandaCost;
      if (typeof savegame.alchemyPandaIncome !== "undefined")
        alchemyPanda.income = savegame.alchemyPandaIncome;
      if (typeof savegame.alchemyPandaUpg !== "undefined")
        alchemyPanda.timesUpg = savegame.alchemyPandaUpg;
      // Bamboo Forest
      if (typeof savegame.bambooForestCost !== "undefined")
        bambooForest.cost = savegame.bambooForestCost;
      if (typeof savegame.bambooForestIncome !== "undefined")
        bambooForest.income = savegame.bambooForestIncome;
      if (typeof savegame.bambooForestUpg !== "undefined")
        bambooForest.timesUpg = savegame.bambooForestUpg;
      // Research Facility
      if (typeof savegame.researchFacilityCost !== "undefined")
        researchFacility.cost = savegame.researchFacilityCost;
      if (typeof savegame.researchFacilityIncome !== "undefined")
        researchFacility.income = savegame.researchFacilityIncome;
      if (typeof savegame.researchFacilityUpg !== "undefined")
        researchFacility.timesUpg = savegame.researchFacilityUpg;
      // Panda School
      if (typeof savegame.pandaSchoolCost !== "undefined")
        pandaSchool.cost = savegame.pandaSchoolCost;
      if (typeof savegame.pandaSchoolIncome !== "undefined")
        pandaSchool.income = savegame.pandaSchoolIncome;
      if (typeof savegame.pandaSchoolUpg !== "undefined")
        pandaSchool.timesUpg = savegame.pandaSchoolUpg;
      // Ninja Panda
      if (typeof savegame.ninjaPandaCost !== "undefined")
        ninjaPanda.cost = savegame.ninjaPandaCost;
      if (typeof savegame.ninjaPandaIncome !== "undefined")
        ninjaPanda.income = savegame.ninjaPandaIncome;
      if (typeof savegame.ninjaPandaUpg !== "undefined")
        ninjaPanda.timesUpg = savegame.ninjaPandaUpg;
      // Hero Upgrades
      //Hero Upgrade 1 (SWORD)
      if (typeof savegame.swordCost !== "undefined")
        sword.hcost = savegame.swordCost;
      if (typeof savegame.swordUpg !== "undefined")
        sword.timesUp = savegame.swordUpg;
      //glory Road (SWORD)
      if (typeof savegame.gloryRoadCost !== "undefined")
        gloryRoad.hcost = savegame.gloryRoadCost;
      if (typeof savegame.gloryRoadUpg !== "undefined")
        gloryRoad.timesUp = savegame.gloryRoadUpg;
      //Hero Upgrade 2
      if (typeof savegame.gfCost !== "undefined") gf.hcost = savegame.gfCost;
      if (typeof savegame.gfUpg !== "undefined") gf.timesUp = savegame.gfUpg;
      // Hero Upgrade 3
      if (typeof savegame.senseiCost !== "undefined")
        sensei.hcost = savegame.senseiCost;
      if (typeof savegame.senseiUpg !== "undefined")
        sensei.timesUp = savegame.senseiUpg;
      //Hero upgrade 4
      if (typeof savegame.clickbetterCost !== "undefined")
        clickbetter.hcost = savegame.clickbetterCost;
      if (typeof savegame.clickbetterUpg !== "undefined")
        clickbetter.timesUp = savegame.clickbetterUpg;
      //Hero upgrade 5
      if (typeof savegame.clickpercCost !== "undefined")
        clickperc.hcost = savegame.clickpercCost;
      if (typeof savegame.clickpercUpg !== "undefined")
        clickperc.timesUp = savegame.clickpercUpg;

      //name
      if (typeof savegame.name !== "undefined") player.name = savegame.name;
      //Boss
      if (typeof savegame.bossHp !== "undefined") boss.hp = savegame.bossHp;
      if (typeof savegame.bossMaxHp !== "undefined")
        boss.maxhp = savegame.bossMaxHp;
      if (typeof savegame.bossTimer !== "undefined")
        boss.timer = savegame.bossTimer;
      if (typeof savegame.bossKills !== "undefined")
        boss.kills = savegame.bossKills;
      if (typeof savegame.bossPerc !== "undefined")
        boss.perc = savegame.bossPerc;
      document.getElementById("selectName").value =
        localStorage.getItem("selectedname");
      if (lazyPanda.timesUpg > 0) {
        $("#buyWorkingPanda").prop("disabled", false) ==
          localStorage.getItem("unlocked");
      }

      if (sword.timesUp > 0) {
        $("#gloryRoad").prop("disabled", false) ==
          localStorage.getItem("unlocked2");
      }
      if (clickbetter.timesUp > 0) {
        $("#heroUpgrade5").prop("disabled", false) ==
          localStorage.getItem("unlocked2");
        $("#heroUpgrade5, .statback10").show() ==
          localStorage.getItem("unlocked2");
      }
      if (gf.timesUp > 0) {
        $("#heroUpgrade3").prop("disabled", false) ==
